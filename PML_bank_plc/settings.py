"""
Django settings for PML_bank_plc project.
...
SECRET_KEY = 'django-insecure-$z)#n*b(0yv1y@kar9vzpnf!h&auo$*4!p&gm3ux3n&$w%*i_a'
...
ROOT_URLCONF = 'PML_bank_plc.urls'
...
WSGI_APPLICATION = 'PML_bank_plc.wsgi.application'
